...
export class Modal {
  ...
  */
  ...
  /**
   * Function to render component portion because of known possible errors with conditionals
   */
  renderSecondary() {
    if (this.secondary !== undefined || this.secondary !== null) {
      return (
        <fl-button onClick={this.secondary}>
          {this.secondaryText}
        </fl-button>
      );
    }
    ...
    return (
      <div class={{
        ...
        <div class={{
          ...
          >
            <i class="fl-icon-x modal-close" onClick={() => this.toggleModal()}>
