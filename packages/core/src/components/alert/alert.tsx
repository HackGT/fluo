...
const toastStack = Object.assign(document.createElement('div'), { className: 'fl-toast-stack' });
...
export class Alert {
  ...
  @Event({ eventName: 'fl-show' }) slShow: EventEmitter;

  /** Emitted after the alert opens and all transitions are complete. */
  @Event({ eventName: 'fl-after-show' }) slAfterShow: EventEmitter;

  /** Emitted when the alert closes. Calling `event.preventDefault()` will prevent it from being closed. */
  @Event({ eventName: 'fl-hide' }) slHide: EventEmitter;

  /** Emitted after the alert closes and all transitions are complete. */
  @Event({ eventName: 'fl-after-hide' }) slAfterHide: EventEmitter;
    ...
    return new Promise<void>(resolve => {
      ...
      this.host.addEventListener(
        ...
        () => {
          ...
          if (toastStack.querySelector('fl-alert') === null) {
            toastStack.remove();
          }
        },
        { once: true }
